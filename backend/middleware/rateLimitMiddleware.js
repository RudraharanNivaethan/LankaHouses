...
export const loginLimiter          = createLimiter(15 * 60 * 1000,   5, 'Too many login attempts. Please try again after 15 minutes.', { skipSuccessfulRequests: true });
export const registerLimiter       = createLimiter(60 * 60 * 1000,   3, 'Maximum registration limit reached. Please try again after 1 hour.');
