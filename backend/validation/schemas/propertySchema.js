...
const PROPERTY_TYPES = ['Apartment', 'House', 'HouseWithLand', 'Villa'];
...
const garageField        = z.boolean({ invalid_type_error: 'Garage must be a boolean' });
...
const descriptionField   = z.string().max(5000, 'Description must be at most 5000 characters');
...
const updateableFields = [
  ...
  'garage', 'area', 'landSize', 'address', 'district', 'province',
